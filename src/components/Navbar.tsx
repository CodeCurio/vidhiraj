            ...
            {activeDropdown === 'collection' && (
               <div className="flex animation-fade-in">
                  ...
                  <div className="w-2/3 pl-10 flex gap-8 h-[350px]">
                      <Link href="/products?category=Copper%20Handicraft" className="flex-1 relative rounded-2xl overflow-hidden group cursor-pointer block" onClick={() => setActiveDropdown(null)}>
                         <img src="/categories/copper-handicraft.jpg" alt="Copper Handicraft" className="absolute inset-0 w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105" />
                         <div className="absolute inset-0 bg-black/30 group-hover:bg-black/20 transition-colors"></div>
                         <div className="absolute bottom-6 left-6 right-6 flex items-center justify-between z-10">
                            <h4 className="text-white text-xl font-bold uppercase tracking-wide font-serif">Copper<br/>Collection</h4>
                      ...
                      <Link href="/products?category=Macrame%20Wall%20Hanging" className="flex-1 relative rounded-2xl overflow-hidden group cursor-pointer block" onClick={() => setActiveDropdown(null)}>
                         <img src="/categories/macrame-wall-hanging.jpg" alt="Macrame Wall Hanging" className="absolute inset-0 w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105" />
                         <div className="absolute inset-0 bg-black/30 group-hover:bg-black/20 transition-colors"></div>
                         <div className="absolute bottom-6 left-6 right-6 flex items-center justify-between z-10">
                            <h4 className="text-white text-xl font-bold uppercase tracking-wide font-serif">Macrame<br/>Collection</h4>
                            <div className="w-10 h-10 rounded-full bg-white/20 backdrop-blur-md flex items-center justify-center group-hover:bg-[#D4AF37] transition-colors">
                               <ArrowRight size={18} className="text-white" />
                            </div>
                         </div>
